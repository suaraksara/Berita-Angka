...
halaman_detik = [str(i) for i in range(1, 40)]
...
for i in halaman_detik:
    indeks_cnbc = 'https://www.antaranews.com/indeks/'+ tanggal+'/'+i 
    sup_cnbc = bikin_sup(indeks_cnbc)
    sleep(0.7)
    berita_cnbc = sup_cnbc.find_all('div', class_='simple-thumb')
...
berita_dg_angka.to_csv(namafile+'_'+'angka_dalam_antara.csv')
